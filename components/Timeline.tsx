...
interface TimelineProps {
  ...
  onToggleDialogueVisible?: () => void;
  onToggleTitlesVisible?: () => void;
  zoom: number;
    ...
    <div className="w-full h-full bg-[#151515] flex flex-col select-none border-t border-[#333]">
      ...
      >
        ...
        >
          ...
          <div className="h-8 relative w-full border-b border-[#333] bg-[#1a1a1a] flex">
            <div className="sticky left-0 w-12 min-w-[3rem] h-full bg-[#202020] border-r border-[#333] flex items-center justify-between px-1 z-50 shadow-[2px_0_5px_rgba(0,0,0,0.2)]">
              <span className="text-[9px] font-bold text-indigo-400">TTL</span>
              <button
                onClick={onToggleTitlesVisible}
                title={titlesLayerVisible ? 'Hide titles' : 'Show titles'}
                className="opacity-60 hover:opacity-100 transition-opacity"
              >
                {titlesLayerVisible
                  ? <svg className="w-3 h-3 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                  : <svg className="w-3 h-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                }
              </button>
            </div>
            <div className={`relative flex-1 h-full ${titlesLayerVisible ? '' : 'opacity-30'}`}>
              {titleLayer && (
                <div
          ...
          <div className="h-10 relative w-full border-b border-[#333] bg-[#1a1a1a] flex">
            <div className="sticky left-0 w-12 min-w-[3rem] h-full bg-[#202020] border-r border-[#333] flex items-center justify-between px-1 z-50 shadow-[2px_0_5px_rgba(0,0,0,0.2)]">
              <span className="text-[9px] font-bold text-purple-400">DLG</span>
              <button
                onClick={onToggleDialogueVisible}
                title={dialogueLayerVisible ? 'Hide dialogue' : 'Show dialogue'}
                className="opacity-60 hover:opacity-100 transition-opacity"
              >
                {dialogueLayerVisible
                  ? <svg className="w-3 h-3 text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                  : <svg className="w-3 h-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                }
              </button>
            </div>
            <div className={`relative flex-1 h-full ${dialogueLayerVisible ? '' : 'opacity-30'}`}>
